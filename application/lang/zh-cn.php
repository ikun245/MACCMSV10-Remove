...
https://www.baidu.com/123.jpg
    ...
    'admin/index/login/title'=>'后台管理中心 - Copyright by @haixianmian8',
    'admin/index/index/name' =>'@haixianmian8',
    'install/title'=>'@haixianmian8 安装',
    'install/header'=>'感谢您选择 @haixianmian8',
    'install/user_agreement_title'=>'@haixianmian8 用户协议 适用于所有用户',
    'install/user_agreement'=>' 请您在使用前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
                一、免责声明：  <br />
                ...
                二、协议规定的约束和限制：  <br />
                禁止去除源码里的版权信息，商业授权版本可去除后台界面及前台界面的相关版权信息。</br>
                禁止在整体或任何部分基础上发展任何派生版本、修改版本或第三方版本用于重新分发。',
    'install/is_ok'=>'系统安装成功，欢迎您使用 @haixianmian8',
