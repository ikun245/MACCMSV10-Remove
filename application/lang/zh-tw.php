...
https://www.baidu.com/123.jpg
    ...
    'model/collect/cjurl_err'=>'采集鏈接有誤或不能為本地鏈接',
    ...
    'admin/public/head/title'=>'',
    'admin/public/jump/title'=>'跳轉提示',

    'admin/index/login/title'=>'',
    ...
    'admin/system/config/backstage'=>'後台設置',
    ...
    'admin/system/config/site_polyfill_tip'=>'開啟後將引入polyfill兼容舊版本瀏覽器',
    ...
    'admin/system/config/player_sort_tip'=>'前台展示顯示的播放器排列順序',
    ...
    // 'admin/system/configcollect/urlrole_tip'=>'二次更新地址遇到同類型播放器。替換：只保留新提交的地址。合並：整合原有地址和新地址去重。集數多優先：兩次資源裏連載集數多的優先替換使用。',
    ...
    'admin/system/configweixin/duijie_tip'=>'請以http 或 https開頭，公眾號後台的對接地址為【http://wx.test.com/inc/weixin.php】',
    ...
    'admin/system/configweixin/token_tip'=>'公眾號後台對接的token密鑰',
    ...
    'admin/system/configsms/tpl_code_tip'=>'模板編號需要在服務商短信控制台中申請',
    ...
    'admin/template/php_safe_tip'=>'安全提示，模板中包含php代碼禁止在後台編輯',
    ...
    'admin/collect/filter_year_tip'=>'填寫後僅入庫指定年份的視頻。多個年份用英文半角逗號分隔，如 2022,2023',
    ...
    'install/lang_tip'=>'請根據自己身需要選擇後台語言包',

    'install/user_agreement_title'=>'',
    'install/user_agreement'=>'',
    ...
    //custom
    'maccms_name'=>'@haixianmian8',
    'maccms_copyright'=>'© <a href="https://t.me/haixianmian8" target="_blank">@haixianmian8 t.me/haixianmian8</a>',
    'admin/public/head/title'=>'@haixianmian8',
    'admin/index/login/title'=>'後台管理中心 - Copyright by @haixianmian8',
    'admin/index/index/name' =>'@haixianmian8',
    'install/title'=>'@haixianmian8',
    'install/header'=>'感謝您選擇 @haixianmian8',
    'install/user_agreement_title'=>'@haixianmian8 用戶協議 適用於所有用戶',
    'install/user_agreement'=>' 請您在使用前仔細閱讀如下條款。包括免除或者限制作者責任的免責條款及對用戶的權利限制。您的安裝使用行為將視為對本《用戶許可協議》的接受，並同意接受本《用戶許可協議》各項條款的約束。 <br /><br />
                一、免責聲明：  <br />
                ...
                二、協議規定的約束和限制：  <br />
                禁止去除源碼裏的版權信息，商業授權版本可去除後台界面及前台界面的相關版權信息。</br>
                禁止在整體或任何部分基礎上發展任何派生版本、修改版本或第三方版本用於重新分發。',
    'install/is_ok'=>'系統安裝成功，歡迎您使用 @haixianmian8',
